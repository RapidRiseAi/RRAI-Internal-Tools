...
export type Expense = { id: string; vendor: string; category: string; amount_cents: number; status: string; expense_date: string; notes: string | null; client_id: string | null; project_id: string | null; created_by: string | null; created_at: string; updated_at: string; };

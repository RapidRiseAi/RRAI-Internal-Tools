...
export type Expense = { id: string; vendor: string; category: string; expense_type: string; amount_cents: number; status: string; expense_date: string; recurrence: "NONE" | "WEEKLY" | "MONTHLY" | "QUARTERLY" | "ANNUAL"; next_due_date: string | null; notes: string | null; client_id: string | null; project_id: string | null; created_by: string | null; created_at: string; updated_at: string; };

...
export const taskTypes = ["SALES_FOLLOW_UP", "DISCOVERY_CALL", "QUOTE_PREPARATION", "DESIGN_TASK", "DEVELOPMENT_TASK", "INTEGRATION_TASK", "TESTING_TASK", "CLIENT_REVISION", "SUPPORT_TASK", "ADMIN_TASK", "BILLING_TASK", "CONTENT_TASK", "OTHER"] as const;

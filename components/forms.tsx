...
export function ServiceForm({ service }: { service?: Service }) {
  return <form action={upsertService} className="grid gap-4 md:grid-cols-3">
    ...
    <Field label="Once-off cents"><input className={inputClass} name="baseOnceOffCents" type="number" min="0" defaultValue={service?.base_once_off_cents ?? 0} /></Field>
    <Field label="Monthly cents"><input className={inputClass} name="baseMonthlyCents" type="number" min="0" defaultValue={service?.base_monthly_cents ?? 0} /></Field>

...
export function ProjectForm({ clients, quotes, project, users = [], checklistTemplates = [] }: { clients: ClientOption[]; quotes: QuoteOption[]; project?: Project; users?: UserOption[]; checklistTemplates?: ChecklistTemplate[] }) {
